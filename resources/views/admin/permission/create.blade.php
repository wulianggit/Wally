                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="" method="post" action="{{ url('admin/permission') }}">
                        ...
                        <div class="item form-group {{$errors->has('display_name') ? 'bad' : ''}}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="display_name" name="display_name" placeholder="{{trans('label.permission.display_name')}}" required="required" class="form-control col-md-7 col-xs-12" value="{{old('username')}}">
                            </div>
                        ...
                        <div class="item form-group {{$errors->has('description') ? 'bad' : ''}}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="description" name="description" placeholder="{{trans('label.permission.description')}}" required="required" class="form-control col-md-7 col-xs-12" value="{{old('password')}}">
                            </div>
